...
//test on a function that returns true if the number === 5. otherwise, returns false.
describe("isFive(num)", () => {
...
//tests a function that sees if a number is odd, positive or negative. otherwise, returns false.
...
//tests a funciton that returns an array of numbers with the min, max. the difference between elements is the step.
